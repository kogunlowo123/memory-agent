...
app = FastAPI(
    title="Memory Agent",
    description="AI memory management agent that implements short-term, long-term, and episodic memory for conversational AI systems, with memory consolidation, retrieval, decay, and privacy-aware forgetting capabilities.",
    version="1.0.0",
    docs_url="/docs",
    redoc_url="/redoc",
    lifespan=lifespan,

"""Memory Agent - Main Agent Implementation."""
...
class MemoryAgentAgent:
    ...
    def __init__(self):
        ...
        self.privacy_forgetting_enabled = True
        self._tool_dispatch = {
            "store_memory": self.tools.store_memory,
            "retrieve_memories": self.tools.retrieve_memories,
            "consolidate_memories": self.tools.consolidate_memories,
            "forget_memories": self.tools.forget_memories,
            "get_memory_stats": self.tools.get_memory_stats,
        }
        logger.info(
            "agent_initialized",
            ...
            features=['short_term_memory', 'long_term_memory', 'episodic_memory', 'memory_consolidation', 'privacy_forgetting'],
        )
    ...
    async def _maybe_execute_tools(self, message: str, context: str) -> list[dict]:
        ...
        tool_keywords = {
            ...
            "forget_memories": ['forget', 'memories'],
